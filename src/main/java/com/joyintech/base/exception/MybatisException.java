...
/**
 * 名称：MybatisException <br>
 * 描述：DAO基本异常定义 <br>
 *       所有Mybatis抛出的异常转换为此异常。 <br>
 * @author 张中伟
 * @version 1.0
 * @since 1.0.0
 */
public class MybatisException extends BaseDaoException {
    ...
    public void initCodeTitle() {
        ...
        this.setExceptionCode("JYN-02002");
        this.setExceptionTitle("数据访问异常");
    }
